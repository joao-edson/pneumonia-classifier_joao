# -*- coding: utf-8 -*-
"""classificacao_pneumonia.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1sNvLwg2qxZTPS3ZRtEcW9o0pUn5Jnv-_
"""
...
!unzip '/content/gdrive/MyDrive/Trabalho IA/PNEUMONIA.zip'
...
base_treinamento = gerador_treinamento.flow_from_directory('/content/gdrive/MyDrive/Trabalho IA/train',
                                                           target_size = (64, 64),
                                                           batch_size = 32,
                                                           class_mode = 'binary')


base_teste = gerador_teste.flow_from_directory('/content/gdrive/MyDrive/Trabalho IA/test',
                                               target_size = (64, 64),
                                               batch_size = 32,
                                               class_mode = 'binary')
